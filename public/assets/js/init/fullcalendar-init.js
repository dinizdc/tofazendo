...
!function($) {
    ...
    CalendarApp.prototype.onEventClick =  function (calEvent, jsEvent, view) {
        var $this = this;
            var form = $("<form></form>");
            form.append("<label>Altere o nome do evento</label>");
    ...
    CalendarApp.prototype.onSelect = function (start, end, allDay) {
        var $this = this;
            ...
            form.find(".row")
                .append("<div class='col-md-6'><div class='form-group'><label class='control-label'>Nome do Evento</label><input class='form-control' placeholder='Insira o nome do evento' type='text' name='title'/></div></div>")
                ...
                .append("<option value='bg-danger'>Vermelho</option>")
                .append("<option value='bg-success'>Verde</option>")
                .append("<option value='bg-dark'>Preto</option>")
                .append("<option value='bg-primary'>Azul</option>")
                .append("<option value='bg-pink'>Rosa</option>")                
                .append("<option value='bg-warning'>Amarelo</option></div></div>");
            ...
            $this.$modal.find('form').on('submit', function () {
                ...
                if (title !== null && title.length != 0) {
                    ...
                    alert('Você tem que atribuir um nome para o seu evento');
                }
                return false;
